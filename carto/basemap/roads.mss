// Major
#global_roads["type"='Major Highway'][zoom>=6][zoom<9] {
  ::outer {
    line-join: round;
    line-color:black;
    line-width: 6;
    [zoom=6] {line-width: 1.6; line-color:@darkgrey;}
    [zoom=7] {line-width: 4; line-color:@darkgrey;}
  }
  ::inner[zoom>=7] {
    line-join: round;
    line-color:@motorway;
...
// Secondary
#global_roads[scalerank<7]["type"='Secondary Highway'][zoom>=6][zoom<9],
#global_roads["type"='Beltway'][zoom>=6][zoom<9] {
  ::outer {
    line-join: round;
    line-color:black;
    line-width: 4;
    [zoom>=6][zoom<8] {line-width: 1.6; line-color:@darkgrey;}
  }
  ::inner[zoom>=8] {
    line-join: round;
    line-color:@primary;
...
// Roads
#global_roads[scalerank<7]["type"='Road'][zoom>=6][zoom<9]{
...
//        [bridge='yes'][length>80] {line-width: 28;}
    ...
    [zoom>=13][type='service']
    {
      ...
      [zoom>=13][zoom<14][length>300][parking_aisle=0]{
        line-color:grey;
        line-width: 2;
      }
      [zoom>=14][zoom<15][length>200][parking_aisle=0] {
        line-width: 5;
      }
      [zoom>=15][zoom<16][length>100][parking_aisle=0],
      [zoom>=15][zoom<16][length>300][parking_aisle=1] {
        line-width: 5;
      }
      [zoom>=16][parking_aisle=0],
      [zoom>=16][length>200][parking_aisle=1]{
        line-width: 6;
      }
    }
  }

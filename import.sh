...
# create new
psql -U postgres -c "create database augsburg;"
psql -U postgres -d augsburg -f /usr/share/postgresql/9.3/contrib/postgis-2.1/postgis.sql
psql -U postgres -d augsburg -f /usr/share/postgresql/9.3/contrib/postgis-2.1/spatial_ref_sys.sql
...
osm2pgsql --slim -G -U postgres -d augsburg -c -S osm2pgsql.style /media/henry/Tools/map/data/extract.osm.pbf
